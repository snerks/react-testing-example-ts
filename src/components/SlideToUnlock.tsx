...
export interface SlideArrowProps {
    triggerXPosition: number;
    onSlide?: Function;
    onReachedTriggerPosition?: Function;
    onPositionChanged?: Function;
}

export interface SlideArrowState {
    held: boolean;
    holdPosition: number;
}

class SlideArrow extends React.Component<SlideArrowProps, SlideArrowState> {

    _isMounted = false;
    holdOffset: number | null = null;
    rect: any;
    el: HTMLDivElement | null = null;

    constructor(props: SlideArrowProps) {
        super(props);
    ...
    handleMove = (event: any) => {
        const clientX = event.clientX || event.touches[0].clientX;
        const holdPosition = this.holdOffset && this.rect && (clientX - this.rect!.left - this.holdOffset);
...
export interface SlideToUnlockState {
    triggerXPosition: number;
}

class SlideToUnlock extends React.Component<SlideToUnlockProps, SlideToUnlockState> {

    arrowHolder: any;

    constructor(props: SlideToUnlockProps) {
        super(props);
